    ...
    public static class ServicesCreator
    {
        ...
        private static void CreateServiceApiForEntities(List<MD_Tabela> tabelas, string path)
        {
            foreach(var table in tabelas)
            {
                ...
                js.AppendLine("     * @param {string} code - The item's unique code.");
                js.AppendLine("     * @param {Object} itemsData - The partial items data to update.");
                js.AppendLine("     * @returns {Promise<Object>} - The updated items data.");
                js.AppendLine("     */");
                js.AppendLine("    update: async (code, itemsData) => {");
                js.AppendLine("        try {");
                js.AppendLine($"            const response = await api.put(`/{NamesHandler.CreateName(table.DAO.Nome)}/${{code}}`, itemsData);");
                js.AppendLine("            return response.data;");
                js.AppendLine("        } catch (error) {");
                ...
                js.AppendLine("");
                js.AppendLine("    /**");
                js.AppendLine("     * Change object status by params.");
                js.AppendLine("     * @param {string} code - The item's unique code.");
                js.AppendLine("     * @param {Object} params - Query parameters such as `isActive`, `isDeleted`.");
                js.AppendLine("     * @returns {Promise<Blob>} - The updated object.");
                js.AppendLine("     */");
                js.AppendLine("    changeStatus: async (code, params) => {");
                js.AppendLine("        try {");
                js.AppendLine($"            const response = await api.put(`/{NamesHandler.CreateName(table.DAO.Nome)}/${{code}}/ChangeStatus`, {{}}, {{");

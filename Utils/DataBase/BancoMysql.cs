...
namespace DataBase
{
    class BancoMysql : Banco
    {
        public BancoMysql(string schema)
        {
            this.tipoBanco = Enumerator.BancoDados.MYSQL;
            this.Schema = schema;
        }
        ...
        public override DbDataReader Select(string command_sql)
        {
            try
            {
                ...
                MySqlCommand command = new MySqlCommand(command_sql, m_dbConnection);
